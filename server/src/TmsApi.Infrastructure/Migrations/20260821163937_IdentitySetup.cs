        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessLicenseNo = table.Column<string>(type: "text", nullable: false),
                    TaxId = table.Column<string>(type: "text", nullable: false),
                    Address = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BidderProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BidderProfiles_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedScore = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BidderProfiles_UserId",
                table: "BidderProfiles",
                column: "UserId",
                unique: true);
